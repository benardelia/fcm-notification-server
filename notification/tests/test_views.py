...
from .factories import ApiClientFactory, ProfileFactory, DeviceFactory, NotificationTemplateFactory
...
class TestSendNotificationView:
    ...
    def test_idempotency_key_prevents_duplicate(self, MockFCM, client):
        ...
        r1 = client.post('/api/v1/notify/', data=payload, content_type='application/json', **headers)
        r2 = client.post('/api/v1/notify/', data=payload, content_type='application/json', **headers)
