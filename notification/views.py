...
from notification.throttling import (AnalyticsThrottle, BulkSendThrottle,
                                     DeviceRegistrationThrottle,
                                     SendNotificationThrottle)

from .filters import (AnalyticsFilter, DeliveryLogFilter, DeviceFilter,
                      NotificationFilter, NotificationTemplateFilter,
                      ProfileFilter, ScheduledNotificationFilter, TopicFilter)
...
from .serializers import (BulkSendNotificationSerializer, DeviceSerializer,
                          FirebaseProjectSerializer,
                          NotificationAnalyticsSerializer,
                          NotificationDeliveryLogSerializer,
                          NotificationSerializer,
                          NotificationTemplateSerializer, ProfileSerializer,
                          RegisterDeviceSerializer,
                          ScheduledNotificationSerializer,
                          SendNotificationSerializer,
                          TemplateSendSerializer, TopicNotificationSerializer,
                          TopicSerializer, UserTopicSerializer,
...
def _get_firebase_project(request, firebase_project_id=None):
    ...
    if api_client and hasattr(api_client, "firebase_projects"):
        ...
        return api_client.firebase_projects.filter(
            ...
            return Response(
                {
                    ...
                    "error": {
                        "code": "not_found",
                        "message": "No active device found for this profile.",
                    },
                },
                status=status.HTTP_404_NOT_FOUND,
            )
            ...
            return Response(
                {
                    ...
                    "error": {
                        "code": "not_found",
                        "message": "No active devices found for the provided phone numbers.",
                    },
                },
                status=status.HTTP_404_NOT_FOUND,
            )
...
class TemplateSendView(APIView):
    ...
    def post(self, request):
        ...
        template = get_object_or_404(
            NotificationTemplate, name=template_name, is_active=True
        )
...
@extend_schema_view(
    list=extend_schema(
        summary="List scheduled notifications", tags=["Scheduled Notifications"]
    ),
    create=extend_schema(
        summary="Create a scheduled notification", tags=["Scheduled Notifications"]
    ),
)
...
@extend_schema_view(
    retrieve=extend_schema(
        summary="Get scheduled notification details", tags=["Scheduled Notifications"]
    ),
    update=extend_schema(
        summary="Update a scheduled notification", tags=["Scheduled Notifications"]
    ),
    partial_update=extend_schema(
        summary="Partial update a scheduled notification",
        tags=["Scheduled Notifications"],
    ),
    destroy=extend_schema(
        summary="Delete a scheduled notification", tags=["Scheduled Notifications"]
    ),
)
class ScheduledNotificationRetrieveUpdateDestroyView(
...
@extend_schema_view(
    ...
    create=extend_schema(
        summary="Create a notification record", tags=["Notifications"]
    ),
)
...
@extend_schema_view(
    ...
    partial_update=extend_schema(
        summary="Partial update a notification", tags=["Notifications"]
    ),
...
@extend_schema_view(
    ...
    partial_update=extend_schema(
        summary="Partial update a delivery log", tags=["Notifications"]
    ),
    destroy=extend_schema(summary="Delete a delivery log", tags=["Notifications"]),
)
class NotificationDeliveryLogRetrieveUpdateDestroyView(
    generics.RetrieveUpdateDestroyAPIView
):
    queryset = NotificationDeliveryLog.objects.all()
    serializer_class = NotificationDeliveryLogSerializer
...
@extend_schema_view(
    list=extend_schema(
        summary="List your Firebase projects", tags=["Firebase Projects"]
    ),
    create=extend_schema(
        summary="Register a Firebase project", tags=["Firebase Projects"]
    ),
)
...
@extend_schema_view(
    retrieve=extend_schema(
        summary="Get Firebase project details", tags=["Firebase Projects"]
    ),
    update=extend_schema(
        summary="Update a Firebase project", tags=["Firebase Projects"]
    ),
    partial_update=extend_schema(
        summary="Partial update a Firebase project", tags=["Firebase Projects"]
    ),
    destroy=extend_schema(
        summary="Delete a Firebase project", tags=["Firebase Projects"]
    ),
)
...
@extend_schema_view(
    ...
    partial_update=extend_schema(
        summary="Partial update a template", tags=["Templates"]
    ),
    destroy=extend_schema(summary="Delete a template", tags=["Templates"]),
)
class NotificationTemplateRetrieveUpdateDestroyView(
    generics.RetrieveUpdateDestroyAPIView
):
